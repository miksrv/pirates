...
- **Timed rounds** — each arena runs a 4-minute round with a live countdown; on timeout the arena freezes, shows a leaderboard and a 15s restart countdown, then resets fresh.
