...
export { captureTheFlag } from './captureTheFlag'
...
export const GAME_MODES: GameMode[] = [lastShipStanding, deathmatch, battleRoyale, kingOfTheHill, teamDeathmatch, captureTheFlag]
